...
namespace CRMS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260827155156_AddRhshfAppraisalAndRiskReview")]
    partial class AddRhshfAppraisalAndRiskReview
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRMS.Domain.Aggregates.Committee.StandingCommittee", b =>
                {
                    ...
                    b.HasIndex("CommitteeType", "LocationId")
                        .IsUnique();
            ...
            modelBuilder.Entity("CRMS.Domain.Aggregates.LoanApplication.DisbursementChecklistItem", b =>
                {
                    ...
                    b.Property<string>("LinkedDocumentCategory")
                        .HasMaxLength(30)
                        .HasColumnType("varchar(30)");
            ...
            modelBuilder.Entity("CRMS.Domain.Aggregates.LoanApplication.LoanApplication", b =>
                {
                    ...
                    b.Property<string>("CreditAppraisalCapacityRating")
                        .HasMaxLength(30)
                        .HasColumnType("varchar(30)");

                    b.Property<decimal?>("CreditAppraisalCurrentRatio")
                        .HasPrecision(10, 4)
                        .HasColumnType("decimal(10,4)");

                    b.Property<decimal?>("CreditAppraisalDscr")
                        .HasPrecision(10, 4)
                        .HasColumnType("decimal(10,4)");

                    b.Property<decimal?>("CreditAppraisalLeverage")
                        .HasPrecision(10, 4)
                        .HasColumnType("decimal(10,4)");

                    b.Property<decimal?>("CreditAppraisalLtv")
                        .HasPrecision(10, 4)
                        .HasColumnType("decimal(10,4)");

                    b.Property<string>("CreditAppraisalMemoFileName")
                        .HasMaxLength(255)
                        .HasColumnType("varchar(255)");

                    b.Property<string>("CreditAppraisalMemoPath")
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)");

                    b.Property<string>("CreditAppraisalNotes")
                        .HasMaxLength(2000)
                        .HasColumnType("varchar(2000)");

                    b.Property<string>("CreditAppraisalRecommendation")
                        .HasMaxLength(30)
                        .HasColumnType("varchar(30)");

                    b.Property<DateTimeOffset?>("CreditAppraisalSavedAt")
                        .HasColumnType("datetime(6)");

                    b.Property<Guid?>("CreditAppraisalSavedByUserId")
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("CreditReviewNote")
                        .HasMaxLength(1000)
                        .HasColumnType("varchar(1000)");
                    ...
                    b.Property<DateTimeOffset?>("LegalReviewCompletedAt")
                        .HasColumnType("datetime(6)");

                    b.Property<string>("LegalReviewNote")
                        .HasMaxLength(1000)
                        .HasColumnType("varchar(1000)");
            ...
            modelBuilder.Entity("CRMS.Domain.Aggregates.LoanApplication.SecurityPerfectionDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("SecurityPerfectionDocuments", (string)null);
                });
            ...
            modelBuilder.Entity("CRMS.Domain.Aggregates.Namp.NampAdvisory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<decimal?>("TechnicalViabilityCategoryWeight")
                        .HasColumnType("decimal(8,2)");

                    b.Property<string>("TechnicalViabilityRating")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");

                    b.Property<decimal?>("TechnicalViabilityScore")
                        .HasColumnType("decimal(6,2)");
                    ...
                    b.ToTable("NampAdvisories", (string)null);
                });
            ...
            modelBuilder.Entity("CRMS.Domain.Aggregates.Namp.NampDirector", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("CRMS.Domain.Aggregates.Namp.NampFinancialAppraisalReport", b =>
                {
                    ...
                    b.Property<string>("DemandEvidenceNote")
                        .HasColumnType("text");
                    ...
                    b.Property<int>("RepaymentSource")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("CRMS.Domain.Aggregates.Namp.NampPreDeploymentChecklistItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("NampApplicationId", "TemplateItemId")
                        .IsUnique();

                    b.ToTable("NampPreDeploymentChecklistItems", (string)null);
                });

            modelBuilder.Entity("CRMS.Domain.Aggregates.Namp.NampPreDeploymentChecklistTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("NampPreDeploymentChecklistTemplates", (string)null);
                });
            ...
            modelBuilder.Entity("CRMS.Domain.Aggregates.OfferLetter.OfferLetter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<DateTime?>("ExpectedDisbursementDate")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("CRMS.Domain.Aggregates.Rhshf.RhshfCreditProfile", b =>
                {
                    ...
                    b.Property<string>("BureauCheckOutcome")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("varchar(20)");

                    b.Property<DateTime?>("BureauCheckedAt")
                        .HasColumnType("datetime(6)");

                    b.Property<int?>("BureauDelinquentFacilities")
                        .HasColumnType("int");

                    b.Property<string>("BureauRawJson")
                        .HasColumnType("longtext");

                    b.Property<int?>("BureauTotalLoans")
                        .HasColumnType("int");

                    b.Property<decimal?>("BureauTotalOutstanding")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("CertifiedByAdmin")
                        .HasMaxLength(200)
                        .HasColumnType("varchar(200)");
                    ...
                    b.Property<string>("RawSubmissionPayload")
                        .IsRequired()
                        .HasColumnType("longtext");
                    ...
                    b.Property<decimal>("TotalEopValue")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("CRMS.Domain.Aggregates.Rhshf.RhshfSupportingDocument", b =>
                {
                    ...
                    b.ToTable("RhshfSupportingDocuments", (string)null);
                });
            ...
            modelBuilder.Entity("CRMS.Domain.Aggregates.Location.Location", b =>
                {
                    b.HasOne("CRMS.Domain.Aggregates.Location.Location", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("CRMS.Domain.Entities.Identity.ApplicationUser", b =>
                {
                    b.HasOne("CRMS.Domain.Aggregates.Location.Location", "Location")
                        .WithMany()
