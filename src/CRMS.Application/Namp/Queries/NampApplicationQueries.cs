    ...
    : IRequestHandler<GetNampApplicationByIdQuery, ApplicationResult<NampApplicationDto>>
{
    ...
    internal static NampApplicationDto MapToDto(
        ...
        app.OfferAcceptedAt,
        app.OfferLapsedAt,
        app.LegalClearedByUserId,
        app.LegalClearedAt,
        app.LegalClearanceNote,
        app.LegalDeclineNote,
        app.LegalReturnNote,
        ...
        app.FineractProductId,
        app.FineractProductName,
        app.FineractNominalInterestRate,
